...
let deviceLanguage = RNLanguages.language.slice(0, 2).toLowerCase()
let countries = null
let Emoji = null
let styles = {}
...
export default class CountryPicker extends Component {
  ...
  //   console.log("onSelectCountry", cca2)
  //   this.setState({
  //     modalVisible: false,
  //     filter: "",
  ...
  //     .map(country => this.getCountryName(country)[0])
  //     .indexOf(letter)
  //   if (index === -1) {
  //     return
  //   }
